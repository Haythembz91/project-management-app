...
const ProjectPageContainer = ({projects}:{projects:Project[]})=>{
    ...
    return (
        <div className={'container-fluid mt-3'}>
            ...
            {cardView?<CardViewProjects projects={projects!}></CardViewProjects>:<ProjectsContainer projects={projects}></ProjectsContainer>}
        </div>
