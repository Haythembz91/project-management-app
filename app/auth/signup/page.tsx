    ...
    return (
        <div className={'col-md-6 mx-auto d-flex flex-column justify-content-center p-2'}>
            <div className={'container-fluid'}>
                <h3 className={'text-center fw-semibold mb-3'}>Create an account</h3>
            ...
            <div>
                <form onSubmit={handleSignup} autoComplete="on">
                    <div className="form-floating mb-3">
                        <input type="text" name={'username'} className="form-control" id="username" placeholder="username" autoComplete="username"/>
                        <label htmlFor="username">Username</label>
                    </div>
                    <div className="form-floating mb-3">
                        <input name={'email'} className="form-control" id="email" placeholder="email" autoComplete="email"/>
                        <label htmlFor="email">Email address</label>
                    </div>
                    <div className="form-floating mb-3">
                        <input type="password" name={'password'} className="form-control" id="password" placeholder="Password" autoComplete="new-password"/>
                        <label htmlFor="password">Password</label>
                    </div>
                    <div className="form-floating mb-3">
                        <input type="password" name={'password-confirm'} className="form-control" id="password-confirm" placeholder="Confirm Password" autoComplete="new-password"/>
                    ...
                    <div className={'mb-3'}>
                        {!isLoading?<button type="submit" className="gradBtn w-100">Signup</button>:
